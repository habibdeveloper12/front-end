    ...
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="card loginContainer shadow-sm mx-auto p-4 ">
          <div>
            ...
            >
              <label htmlFor="email">Course Owner Email</label>
              <input
                {...register("email", {
                  required: {
                    value: true,
            ...
            <div className="mt-4 position-relative">
              <label htmlFor="password">Course Owner Password</label>
              <input
                {...register("password", {
                  required: {
                    value: true,
      ...
      <div>
        <p className="text-center mt-2">
          <span className="me-2">Not a member yet?</span>
          <span
            onClick={() => navigete("/adviserSignUp")}
